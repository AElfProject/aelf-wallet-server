...
(function($)
{
	...
	$.fn.cropOpenWindowToCrop = function (ipt, data, width, height, opts) {
		...
		/*$('#crop-window .content').height($('#crop-window .crop-window-wrapper').height() - 28 - 62);  //在这里可能会由于图片没有加载完，算出的高度不正确*/
		...
		setTimeout(function(){ $('#crop-window .content').height($('#crop-window .crop-window-wrapper').height() - 28 - 62); }, 1000);
